        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioPorSucursalExtra = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SucursalesIncluidas = table.Column<int>(type: "int", nullable: false),
                    Activo = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PagoSubscriptions", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagoSubscriptions_Status",
                table: "PagoSubscriptions",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_PagoSubscriptions_SubscriptionId",
                table: "PagoSubscriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_TenantId_Activa",
                table: "Subscriptions",
            ...
            migrationBuilder.AddForeignKey(
                ...
                table: "ControlesOrtodoncia",
                column: "TratamientoOrtodonciaId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PagoSubscriptions_Subscriptions_SubscriptionId",
                table: "PagoSubscriptions",
                column: "SubscriptionId",
                principalTable: "Subscriptions",
                principalColumn: "Id",
